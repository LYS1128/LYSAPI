// MyStardew.cpp : 응용 프로그램에 대한 진입점을 정의합니다.
//
	...
	_In_ int       nCmdShow)
{
	...
	LoadStringW(hInstance, IDC_MYSTARDEW, szWindowClass, MAX_LOADSTRING);
	...
	HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_MYSTARDEW));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDC_MYSTARDEW));
